...
- **Version type**: patch, minor, or major (from $ARGUMENTS; ask the user if not specified)
...
2. **Review and update documentation**:
   - Follow the documentation review process from `commit.md` step 2
...
See [.claude/docs/versioning.md](../docs/versioning.md) for the full version-source reference.
